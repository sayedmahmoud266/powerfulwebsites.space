  ...
  template: `
    <main class="mx-auto px-4 py-8">
      ...
      <section class="text-center py-12 lg:py-16" aria-labelledby="hero-heading">
        <h1 id="hero-heading" class="text-4xl sm:text-5xl md:text-6xl font-bold text-zinc-100 mb-6">
          Discover <span class="text-orange-400">Powerful</span> Websites
        </h1>
        <p class="text-lg sm:text-xl text-zinc-400 mb-8 max-w-3xl mx-auto leading-relaxed">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            routerLink="/search"
            class="btn-primary inline-block w-full sm:w-auto text-center focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 focus:ring-offset-zinc-900"
          ...
          <a
            ...
            class="btn-secondary inline-block w-full sm:w-auto text-center focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 focus:ring-offset-zinc-900"
      ...
      <section class="py-12 lg:py-16" aria-labelledby="latest-heading">
        ...
        >
          <h2 id="latest-heading" class="text-2xl sm:text-3xl font-bold text-zinc-100">
            Latest Additions
          </h2>
          <a
            routerLink="/search"
            class="text-orange-400 hover:text-orange-500 transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 focus:ring-offset-zinc-900 rounded px-2 py-1"
        ...
        <div class="text-center py-16" role="status" aria-live="polite">
          ...
          <p class="text-zinc-500 mb-4">Be the first to add a website to our collection!</p>
          <a
            href="https://github.com/sayedmahmoud266/powerfulwebsites.space/issues/new?template=add-website.md&title=Add%20Website%3A%20[Website%20Name]"
            target="_blank"
            rel="noopener noreferrer"
      ...
      <section class="py-12 lg:py-16 border-t border-orange-700" aria-labelledby="features-heading">
        <h2
          id="features-heading"
          class="text-2xl sm:text-3xl font-bold text-zinc-100 text-center mb-12"
        >
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="text-center">
            ...
            <h3 class="text-xl font-semibold text-zinc-100 mb-2">Curated Collection</h3>
          ...
          <div class="text-center">
            ...
            <h3 class="text-xl font-semibold text-zinc-100 mb-2">Easy Discovery</h3>
            <p class="text-zinc-400">
          ...
          <div class="text-center">
            ...
            <h3 class="text-xl font-semibold text-zinc-100 mb-2">Open Source</h3>
            <p class="text-zinc-400">
