    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="max-w-4xl mx-auto">
        <div class="animate-pulse">
          <div class="h-8 bg-dark-700 rounded mb-6 w-32"></div>
          <div class="flex items-start space-x-6 mb-8">
            <div class="w-24 h-24 bg-dark-700 rounded-lg"></div>
            <div class="flex-1">
              <div class="h-8 bg-dark-700 rounded mb-4"></div>
              <div class="h-6 bg-dark-700 rounded mb-4"></div>
              <div class="flex space-x-2">
                <div class="h-8 w-24 bg-dark-700 rounded-full"></div>
                <div class="h-8 w-32 bg-dark-700 rounded-full"></div>
              </div>
            </div>
          </div>
          <div class="h-32 bg-dark-700 rounded mb-6"></div>
          <div class="h-12 bg-dark-700 rounded"></div>
        </div>
      </div>
      } @else if (!website()) {
      <!-- Error State -->
      <div class="text-center py-16">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a routerLink="/search" class="btn-secondary"> Browse All Websites </a>
        </div>
      </div>
      } @else {
      <!-- Website Detail -->
      <div class="max-w-4xl mx-auto">
        ...
        <nav class="flex items-center space-x-2 text-sm text-gray-400 mb-6">
          ...
          <a routerLink="/search" class="hover:text-primary-400 transition-colors">Search</a>
          <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            <path
              fill-rule="evenodd"
              d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
        ...
        <div class="card">
          ...
          <div class="flex items-start space-x-6 mb-8">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-gray-400 mb-4">Added on {{ formatDate(website()!.created_at) }}</p>
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            ...
            <a routerLink="/search" class="btn-secondary"> Browse More </a>
          </div>
        </div>
        ...
        @if (website()!.tags && website()!.tags!.length > 0) {
        <div class="mt-12">
          <h2 class="text-2xl font-bold text-gray-100 mb-6">Similar Websites</h2>
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <a
              ...
              class="inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium bg-dark-700 hover:bg-dark-600 text-gray-300 hover:text-primary-400 border border-dark-600 hover:border-primary-400 transition-all"
            >
              {{ tag.name }}
