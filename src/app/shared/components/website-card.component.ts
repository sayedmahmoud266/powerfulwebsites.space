...
@Component({
  ...
  template: `
    <article
      class="bg-zinc-900 rounded-lg shadow-lg hover:shadow-orange-600/30 hover:shadow-xl transition-all duration-200 group overflow-hidden"
      role="article"
    >
      <!-- Logo Section -->
      <div
        class="relative h-32 bg-gradient-to-br from-zinc-700 to-zinc-800 flex items-center justify-center"
      >
        @if (website().logo_url) {
        <img
        ...
        <div
          class="w-16 h-16 bg-gradient-to-br from-zinc-600 to-zinc-700 rounded-lg flex items-center justify-center"
          aria-hidden="true"
        >
      ...
      <div class="p-4">
        ...
        <a
          ...
          class="block group-hover:text-orange-400 transition-colors focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 focus:ring-offset-zinc-800 rounded"
        ...
        <!-- Description -->
        <p class="text-zinc-300 text-sm mb-3 line-clamp-2" [attr.title]="website().description">
          {{ website().description }}
        </p>

        <!-- Tags -->
        @if (website().tags && website().tags!.length > 0) {
        <div class="flex flex-wrap gap-2 mb-3" role="list" aria-label="Website tags">
