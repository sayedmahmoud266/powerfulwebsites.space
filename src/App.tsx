        ...
        <header className="sticky top-0 z-50 bg-black/80 backdrop-blur-md border-b border-gray-800/50">
          <div className="container mx-auto px-6 py-6">
            <div className="flex items-center justify-center space-x-3">
              <Zap className="w-6 h-6 lg:w-8 lg:h-8 text-orange-400" />
              <h1 className="text-2xl lg:text-4xl font-bold bg-gradient-to-r from-white via-orange-400 to-orange-600 bg-clip-text text-transparent font-bungee">
        ...
        <section className="container mx-auto px-6 py-12">
          <div className="text-center space-y-6">
            ...
            <div className="text-sm text-gray-400 flex items-center justify-center space-x-2">
              <span>
                Showing {filteredWebsites.length} of {websites.length} powerful websites
              </span>
              ...
              {filteredWebsites.length > 0 ? (
                ...
                <div className="text-center py-20">
                  <div className="space-y-4">
                    ...
                    <h3 className="text-2xl font-bold text-gray-400">No websites found</h3>
          ...
          <div className="container mx-auto px-6 py-8">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              <div className="text-gray-400 text-sm">
                © 2025 powerfulwebsites.space - A curated collection of powerful web tools
              </div>
